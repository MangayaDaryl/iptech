...
// Query the database for products from the aircondition category
$query = "SELECT * FROM products_tbl WHERE category = 'aircondition'";
...
<div class="container d-flex justify-content-center mt-50 mb-50">
    ...
    <img src="/public/images/aircon/<?php echo $product['image_url']; ?>" width="200" height="200" alt="<?php echo $product['product_name']; ?>">
</a>
 </div>
