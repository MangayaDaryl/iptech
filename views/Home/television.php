...
// Query the database for products from the television category
$query = "SELECT * FROM products_tbl WHERE category = 'television'";
...
<div class="container d-flex justify-content-center mt-50 mb-50">
    ...
    <img src="/public/images/tv/<?php echo $product['image_url']; ?>" width="200" height="200" alt="<?php echo $product['product_name']; ?>">
</a>
 </div>
